...
def draw_menu(stdscr,tilist,conflist,Fconf,F_Done):
    ...
    # Existance
    direxists, fileexists = existance()
    ...
    while (k != curses.KEY_F12 or tuiQuit == True):
        ...
        if Status == 2:
            tilist = loadImage2("./image/04_Distrakt.ti")
            renderTopper()
            renderImage()
            renderStatusBar()
        ...
        # Status 3. Purging.
        if Status == 3:
            tilist = loadImage2("./image/03_Purging.ti")
            renderTopper()
            renderImage()
            renderStatusBar()
            if firstPurge == True:
                ...
                disablePilotServices()
                smallWindow("Services are disabled.",3)
                removePilotDirectory()
        ...
        if Status == 4:
            tilist = loadImage2("./image/05_AllsClear.ti")
            renderTopper()
            renderImage()
            renderStatusBar()
            outstring1 = "  Clear,  "
        ...
        if Status == 5:
            tilist = loadImage2("./image/01_Downloading.ti")
            renderTopper()
            renderImage()
            renderStatusBar()
            outstring1 = " LOADING "
        ...
        # Status 6. Unpacking.
        if Status == 6:
            tilist = loadImage2("./image/02_Unpacking.ti")
            renderTopper()
            renderImage()
            renderStatusBar()
            outstring1 = " UNZIP "
        ...
        if Status == 7:
            tilist = loadImage2("./image/06_Construction.ti")
            renderTopper()
            renderImage()
            renderStatusBar()
            outstring1 = " SET UP "
        ...
        if Status == 8:
            tilist = loadImage2("./image/07_Launch.ti")
            renderTopper()
            renderImage()
            renderStatusBar()
            outstring1 = " TEST "
        ...
        # Status 9. System.
        if Status == 9:
            tilist = loadImage2("./image/08_System.ti")
            renderTopper()
            renderImage()
            renderStatusBar()
            outstring1 = " SYSTEM "
        ...
        # Status 10. System.
        if Status == 10:
            tilist = loadImage2("./image/09_Complete.ti")
            renderTopper()
            renderImage()
            renderStatusBar()
            outstring1 = " SYSTEM "
        ...
        # Status 11. Connect.
        if Status == 11:
            tilist = loadImage2("./image/10_Connect.ti")
            renderTopper()
            renderImage()
            renderStatusBar()
            outstring1 = " SYSTEM "
        ...
        # Status 12. UPDATE.
        if Status == 12:
            tilist = loadImage2("./image/11_Update.ti")
            renderTopper()
            renderImage()
            renderStatusBar()
            outstring1 = " SYSTEM "
